...
public class TestRestconfDiscoveryNode {
    ...
    @Test
    public void testEstablishPersistentConnection() throws SvcLogicException, InterruptedException {
    ...
    @Test(expected = SvcLogicException.class)
    public void testEstablishSubscriptionWithoutSubscriberId() throws SvcLogicException{
        SvcLogicContext ctx = new SvcLogicContext();
        Map<String, String> p = new HashMap<>();
        RestconfDiscoveryNode rdn = new RestconfDiscoveryNode();
    ...
    public void testOutputIdentifier() {
        SvcLogicContext ctx = new SvcLogicContext();
        ctx.setAttribute("restapi-result.ietf-subscribed-notifications:output.identifier", "89");
        ctx.setAttribute("ietf-subscribed-notifications:output.identifier", "89");
        RestconfDiscoveryNode rdn = new RestconfDiscoveryNode();
