...
/**
 * Abstraction of an entity which helps the data format serializer to obtain
...
public abstract class SerializerHelper<T, P> {
    ...
    /**
     * Exits the node, in case if it is a leaf node it adds it to the
     * properties map.
     */
     ...
     */
    protected abstract Object getPropertiesNode();
}
